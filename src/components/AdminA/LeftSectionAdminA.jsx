...
import { Ballot, Ballot2, Ballot3, BcLogo } from "../../assets";
...
const LeftSectionAdminA = () => {
  ...
  return (
    <div className="h-full p-10 flex flex-col bg-gradient-to-b from-emerald-950 to-emerald-100 backdrop-blur-md shadow-2xl min-w-96 w-96 gap-3 overflow-auto">
      <img src={Ballot3} className="flex flex-col items-center ml-16 w-40 h-44 -mt-12" alt="" />
      <hr className="mt-1" />
