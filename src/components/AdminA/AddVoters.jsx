...
const AddVoters = () => {
  ...
  const handleFingerprintScan = async () => {
    try {
      ...
      // const finalTemplate = response.data.fingerprint1
      const fingerprintId = response.data.fingerprintId;
      ...
      // setData((prevData) => ({ ...prevData, fingerprint1: finalTemplate }));
      setData((prevData) => ({ ...prevData, fingerprintId: fingerprintId }));
